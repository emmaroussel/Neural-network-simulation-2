...
Warning : python does not work on the Virtual Machine… I joined in the graphs folder the python files, the scatter plot and histogramme produced for each of plots of Figure8 of Brunel’s paper. The results are quiet similar as the ones expected (especially for the scatter plots).
