 ...
 * between these two type of neurons is the sign and value of the weight of their connexions.
...
class Neuron {
  public :
     ...
     * the spikes from possible external connexion(s) from external neurons
     * (simulated with a poisson distribution).
     */
     ...
     * \param j total response amplitude
     *
...
>>>>>>> 6c191c032fdcfd2317cff70767da18ca6111a8da
     ...
     * index simultaneously with time of simulation (local time), when we compute
